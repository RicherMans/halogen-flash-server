...
#
#   docker build -t ghcr.io/<you>/halogen-flash-server:0.5.2 -f Dockerfile .
#
...
#     ghcr.io/<you>/halogen-flash-server:0.5.2
#
...
FROM ghcr.io/peonist-ai/halogen-flash-server:0.5.2
